...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "tor ball") || (event.body.toLowerCase() == "bal")) {
     return api.sendMessage("~ এসব বাজে ভাষা ব্যবহার করো না।.. 🔪😊", threadID);
   };

  if ((event.body.toLowerCase() == "jihad") || (event.body.toLowerCase() == "Jihad bai") || (event.body.toLowerCase() == "@Jihad") || (event.body.toLowerCase() == "জিহাদ")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ Jihad ッ ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 jihad.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com/mk.jihad.914186\nতার সাতে যোগা যোগ করবেন WhatsApp :- +0175570***", threadID);
   };

   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator:JIHAD ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস জিহাদ আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "Jihad") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is Jihad ッ❤️ তাকে সবাই জিহাদ নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "sala ami tor boss") || (event.body.toLowerCase() == "sala ami jihad") || (event.body.toLowerCase() == "cup sala ami jihad") || (event.body.toLowerCase() == "madari")) {
     return api.sendMessage("সরি বস মাফ করে দেন আর এমন ভুল হবে না🥺🙏", threadID);
   };

   if ((event.body.toLowerCase() == "@Farhana Ontora") || (event.body.toLowerCase() == "@Farhana Ontora ")) {
     return api.sendMessage("খবরদার কেউ এই আইড়ি মেনশন দিবানা এটা আমার বস জিহাদ এর বউ এর আইডি 😠🥰⛏️", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "@MD Shiam Tafeder ") || (event.body.toLowerCase() == "সিয়াম")) {
     return api.sendMessage("🥰-সিয়াম-🌺 আমার বস জিহাদ'র বন্ধু লাগে লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "tnx") || (event.body.toLowerCase() == "ধন্যবাদ") || (event.body.toLowerCase() == "thank you") || (event.body.toLowerCase() == "thanks")) {
     return api.sendMessage("️এতো ধন্যবাদ না দিয়ে পারলে গার্লফ্রেন্ড টা দিয়ে দে আমার বস জিহাদ কে..!🌚⛏️🌶️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "কেমন আছো") || (event.body.toLowerCase() == "কেমন আছেন") || (event.body.toLowerCase() == "Kmon acho") || (event.body.toLowerCase() == "how are you") || (event.body.toLowerCase() == "how are you?")) {
     return api.sendMessage("আমি তখনই ভালো থাকি যখন মিম কে হাসতে দেখি🤎☺️", threadID);
   };

   if ((event.body.toLowerCase() == "Tanha") || (event.body.toLowerCase() == "tanha")) {
     return api.sendMessage("Tanha ar Jihad.. 💪🫶🫀😚", threadID);
   };

 if ((event.body.toLowerCase() == "Prima") || (event.body.toLowerCase() == "prima")) {
     return api.sendMessage("ওই ওরে কেউ নাম ধরে ডাকবি না cutie বলবি.. 🫶😚🥀", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Admin ke ") || (event.body.toLowerCase() == "Ami tor boss")) {
     return api.sendMessage(" জিহাদ বস আসসালামু আলাইকুম। কোন ভুল হলে মাফ করবেন <😘", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "ami Jihad") || (event.body.toLowerCase() == "kire")) {
